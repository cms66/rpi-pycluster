...
install_opencv_local()
{
    ...
    mkdir -p $usrpath/share1/setup/python3/
 	cp -r $usrpath/.venv/lib/python3.11/site-packages/cv2 $usrpath/share1/setup/python3/
    chown -R $usrname:$usrname $usrpath/share1/setup/python3/
